<section id="heroSection" data-sc-act="flow" style="width:100%;min-height:100vh;position:relative;overflow:hidden;display:flex;align-items:center;justify-content:center">
    ...
    <div data-sc-parallax="0.25" style="position:relative;z-index:2;max-width:900px;margin:0 auto;padding:24px;text-align:center">
