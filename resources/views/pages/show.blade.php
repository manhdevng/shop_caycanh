...
@section('title', $page->title . ' · Cây Cảnh Shop')
...
<nav aria-label="breadcrumb" style="max-width:900px;margin:0 auto;padding:18px 24px 0;font-size:13px;color:#8A8680;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
    ...
    <span>&rsaquo;</span>
    <span style="color:#1C1C1A">{{ $page->title }}</span>
</nav>

<section style="max-width:900px;margin:0 auto;padding:20px 24px 24px">
    <h1 style="font-family:'Anton',sans-serif;font-size:clamp(28px,4.5vw,46px);line-height:1.15;letter-spacing:0.01em;text-transform:uppercase;color:#1C1C1A;margin:0">{{ $page->title }}</h1>
</section>
